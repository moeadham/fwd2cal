...
<br><br>You can always ask for help: <a href="mailto:%SUPPORT_EMAIL%">%SUPPORT_EMAIL%</a>
`,
  },
  oauthFailed: {
...
`,
  ...
  additionalEmailInUse: {
    html: `Sorry - but %EMAIL_TO_ADD% is already in use by another fwd2cal account. If you want to add it to this account, you'll need the current account holder to send an email to %MAIN_EMAIL% with the subject "remove %EMAIL_TO_ADD%"
...
<br><br>You can always ask for help: <a href="mailto:%SUPPORT_EMAIL%">%SUPPORT_EMAIL%</a><br>`,
  ...
  userDeleted: {
    html: `Sorry to see you go! Your account has been completely deleted. You can always sign up again by sending an email to <a href="mailto:%MAIN_EMAIL%?subject=signup">%MAIN_EMAIL%</a>.<br><br>
