...
`,
  ...
  unverifiedEmail: {
    html: `Sorry - but something is wrong with your e-mail configuration and we can't verify you're actually %FROM_EMAIL%.

<br><br>You can always ask for help: <a href="mailto:support@fwd2cal.com">support@fwd2cal.com</a>
`,
  },
  oauthFailed: {
    html: `Sorry - there was an issue authenticating with Google. Please click <a href="https://app.fwd2cal.com/v2/signup">to authorize Google again</a>, and then forward your thread another time.
...
<br><br>You can always ask for help: <a href="mailto:support@fwd2cal.com">support@fwd2cal.com</a><br>`,
  ...
  unableToParse: {
    html: `Sorry - AI wasn't able to find a date in your email. Forward the thread again and include some instructions to help AI figure it out.

<br><br>You can always ask for help: <a href="mailto:support@fwd2cal.com">support@fwd2cal.com</a><br>`,
  },
  aiParseError: {
    html: `Sorry - AI wasn't able to find a date in your email. %PARSE_ERROR_DESCRIPTION%
Forward the thread again and include some instructions to help AI figure it out.

<br><br>You can always ask for help: <a href="mailto:support@fwd2cal.com">support@fwd2cal.com</a><br>`,
  },
  eventAddedICS: {
    html: `The email you forwarded had an ICS file. This event has been added to your calendar:
...
<br><br>You can always ask for help: <a href="mailto:support@fwd2cal.com">support@fwd2cal.com</a><br>`,
  ...
  icsError: {
    html: `The email you forwarded had an ICS file. But there was an error processing it.

<br><br>You can always ask for help: <a href="mailto:support@fwd2cal.com">support@fwd2cal.com</a><br>`,
  },
  eventAdded: {
    html: `Event added to your calendar.
<br>Date: %EVENT_DATE%
...
<br><br>You can always ask for help: <a href="mailto:support@fwd2cal.com">support@fwd2cal.com</a><br>`,
  ...
  addAdditionalEmailAddress: {
    ...
    html: `To join %ORIGINATOR_EMAIL%'s fwd2cal account, please click <a href="https://app.fwd2cal.com/v2/verifyAdditionalEmail?uuid=%VERIFICATION_CODE%">here</a><br><br>
...
`,
  ...
  additionalEmailInUse: {
    html: `Sorry - but %EMAIL_TO_ADD% is already in use by another fwd2cal account. If you want to add it to this account, you'll need the current account holder to send an email to calendar@fwd2cal.com with the subject "remove %EMAIL_TO_ADD%"

<br><br>You can always ask for help: <a href="mailto:support@fwd2cal.com">support@fwd2cal.com</a><br>`,
  },
  removalEmailInUse: {
    html: `Sorry - but %EMAIL_TO_REMOVE% is in use by another fwd2cal account, not your account."

<br><br>You can always ask for help: <a href="mailto:support@fwd2cal.com">support@fwd2cal.com</a><br>`,
  },
  emailAddressRemoved: {
    html: `%EMAIL_TO_REMOVE% has been removed from your account.

<br><br>You can always ask for help: <a href="mailto:support@fwd2cal.com">support@fwd2cal.com</a><br>`,
  },
  userDeleted: {
    html: `Sorry to see you go! Your account has been completely deleted. You can always sign up again by sending an email to <a href="mailto:calendar@fwd2cal.com?subject=signup">calendar@fwd2cal.com</a>.<br><br>
