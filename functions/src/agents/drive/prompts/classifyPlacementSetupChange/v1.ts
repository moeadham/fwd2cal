...
Return is_change true when the reply asks to alter granularity. Return false when the reply is approval, vague discussion, or an unrelated folder/filename change.
